...
Challenge.create(title: "Ausschalten-und-Ausstrecken-Challenge",
  ...
  submission: "Überlege dir welche Geräte bei dir zu Hause unnötig auf Standby geschalten oder angesteckt sind, obwohl das nicht notwendig ist. Stelle fest für wie viele Stunden pro Tag das der Fall ist. Stecke sie dann aus und berechne anhand der Tabelle, wie viele kWh du in einer Woche sparen konntest. ",
  category: energie)
...
Challenge.create(title: "Leitungswasser-Challenge",
  ...
  submission: "Beobachte, wie viele Liter Mineralwasser du in einer Woche trinkst. Nach der durchgestandenen Challenge gib uns bitte an, wieviele Kilogramm CO<sub>2</sub> du eingespart hast (pro Liter Mineralwasser spart man 210g CO<sub>2</sub>).",
  category: wasser)
...
Challenge.create(title: "Tee-statt-Kaffee-Challenge",
  ...
  submission: "Rechne nach, wie viele Tassen Kaffee du normalerweise trinkst. Pro Tasse, statt der du Tee anstelle von Kaffee trinkst, sparst du 75 Gramm CO<sub>2</sub> ein. Gib an, wie viele Kilogramm CO<sub>2</sub> du nach einer Woche eingespart hast. ",
  category: ernaehrung)
...
Challenge.create(title: "Schweinefleisch-Challenge",
  ...
  submission: "Gib an, wieviele Kilogramm CO<sub>2</sub> du eingespart hast.",
  category: ernaehrung)

Challenge.create(title: "Butter-Challenge",
  description: "Ein Marmeladebrot ohne Butter? Unvorstellbar ... oder doch nicht? Butter ist vor allem wegen seiner aufwändigen und energieintensiven Herstellung klimaschädlich. Verpackung, Transport und Kühlkette tragen noch ihres dazu bei. Weiters wird Butter aus Kuhmilch hergestellt. Wie wir wissen ist Kuhhaltung sehr schädlich für unser Klima. Die Challenge: Verzichte eine Woche auf deine Butter und hilf mit, das Klima zu retten.",
  submission: "Gib an, wie viele Kilogramm CO<sub>2</sub> du im Vergleich zu einer herkömmlichen Woche eingespart hast (1 kg Butter = 24 kg CO<sub>2</sub>-Einsparung)",
  category: ernaehrung)

Challenge.create(title: "Vegan/Vegetarisch-Challenge",
  description: "Bei der Herstellung von einem Kilo Rindfleisch fallen 13,3 Kilogramm CO<sub>2</sub> an. Die kann man leicht einsparen, wenn man die Tiere nicht mehr isst. Rinder haben eine besonders schlechte Klimabilanz, weil sie zudem ordentlich Methan ausstoßen. Methan ist wie Kohlendioxid ein Treibhausgas. Es ist aber 25-mal schädlicher als CO<sub>2</sub>. Und: Kühe fressen enorme Mengen Soja. Für den Sojabohnen-Anbau wird der Regenwald abgeholzt. Wer also nicht ganz auf Fleisch verzichten will, der sollte am ehesten auf Rindfleisch verzichten und vielleicht ab und zu Hühnchen essen. Mit der Grundsatzentscheidung für eine vegetarische oder vegane Ernährungsweise schaffst du klare Verhältnisse. Schaffst du es, dich eine Woche lang vegetarisch oder vegan zu ernähren?",
...
Challenge.create(title: "Sommerlager-Challenge",
  ...
  submission: "Überlegt, wie viele PKW und sonstige Fahrzeuge üblicherweise für die Anreise zum Sommerlager benötigt werden, berechnet die Kilometer mit einer Straßenkarte und berechnet, wie viele Kilogramm CO<sub>2</sub> ihr insgesamt für dieses Sommerlager eingespart habt.",
  category: verkehr)
